...
- [x] Determine a weighted formula based on Core Web Vitals (e.g., LCP 30%, CLS 30%, FCP 40% or standard Lighthouse weights).
- [x] Map raw values to a 0-100 log-normal distribution (similar to Lighthouse).

### AC 2: Score Display
- [x] `ScoreGauge` component displays the score as a radial chart.
- [x] Color coded: 0-49 (Red), 50-89 (Orange), 90-100 (Green).

### AC 3: Real-time Recalculation
- [x] Score updates whenever individual vitals values change.
