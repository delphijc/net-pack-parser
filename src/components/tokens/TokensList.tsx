...
import { Search, ArrowDown, ArrowUp, Hash, FileText } from 'lucide-react';
          ...
          <table className="w-full">
            ...
            <tbody className="divide-y divide-gray-700">
              {filteredAndSortedTokens.map((token) => (
                <tr key={token.value} className="hover:bg-gray-750">
                  <td className="px-4 py-3 whitespace-nowrap">
                    <div className="flex items-center">
                      <Hash size={16} className="text-blue-400 mr-2" />
                      <code className="text-sm bg-gray-900 px-2 py-0.5 rounded">
                        {token.value}
                      </code>
                    </div>
                  </td>
                  ...
                  <td className="px-4 py-3 whitespace-nowrap">
                    <div className="flex items-center text-sm text-gray-400">
                      ...
                      {token.packetCount} packet{token.packetCount !== 1 ? 's' : ''}
                    </div>
                  </td>
                </tr>
              ))}
