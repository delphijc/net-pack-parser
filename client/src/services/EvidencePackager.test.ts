...
describe('EvidencePackager', () => {
    ...
    beforeEach(() => {
        ...
        useSessionStore.setState({
            sessions: [
                { id: 'session-1', name: 'Test Session', timestamp: 1234567890, packetCount: 100 },
            ],
    ...
    it('should handle missing session gracefully', async () => {
        ...
        expect(mockFile).toHaveBeenCalledWith('case-metadata.json', expect.stringContaining('unknown'));
    });
});
