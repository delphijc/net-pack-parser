        ...
        default: class {
            ...
            decode() {
                ...
                const mockPacketData = new Uint8Array([
                    ...
                    0x45, 0x00, 0x00, 0x3c, 0x1c, 0x46, 0x40, 0x00, 0x40, 0x06, 0xb1, 0xe6, 0xc0, 0xa8, 0x00, 0x01, // Source IP: 192.168.0.1
                    ...
                    0x00, 0x50, // Dest Port: 80 (0x0050)
                    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x50, 0x02, 0x20, 0x00, 0xaf, 0x0e, 0x00, 0x00,
...
describe('pcapParser', () => {
    ...
    it('should parse string data correctly', async () => {
        ...
        expect(new TextDecoder().decode(result[0].rawData as ArrayBuffer)).toBe(input);
