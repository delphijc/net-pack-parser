...
export const ExportControl: React.FC<ExportControlProps> = ({ pcapFile, disabled }) => {
    ...
    const handleExport = async () => {
        ...
        try {
            ...
            const hash = await evidencePackager.exportPackage(pcapFile, pcapFile.name);
            setLastHash(hash);

            logAction('EXPORT', `Exported Evidence Package for ${pcapFile.name}`, { packageHash: hash });
