...
describe('FilesTab', () => {
    ...
    beforeEach(() => {
        ...
        (ChainOfCustodyDb.addFileChainOfCustodyEvent as any).mockResolvedValue('event-id');
    });
    ...
    it('handles file download', async () => {
        ...
        expect(globalThis.URL.createObjectURL).toHaveBeenCalledWith(mockFileRef.data);
    ...
    it('displays message when no files detected', () => {
        ...
        expect(screen.getByText('No file references detected for this packet.')).toBeInTheDocument();
    });
});
