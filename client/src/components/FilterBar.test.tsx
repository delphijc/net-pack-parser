...
describe('FilterBar', () => {
  ...
  it('renders correctly', () => {
    ...
    expect(
      screen.getByPlaceholderText(/Enter BPF filter/i),
    ).toBeInTheDocument();
  ...
  it('displays filtered packet count', () => {
    render(
      <FilterBar {...defaultProps} packetCount={50} totalPacketCount={100} />,
    );
    ...
    expect(
      screen.getByText('Showing 50 of 100 packets (filtered)'),
    ).toBeInTheDocument();
  });
});
