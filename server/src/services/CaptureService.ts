...
export class CaptureService {
    ...
    public static async startCapture(interfaceName: string, filter?: string, sizeLimit?: number): Promise<CaptureSession> {
    ...
    public static stopCapture(interfaceName: string): { packetCount: number, output: string } {
